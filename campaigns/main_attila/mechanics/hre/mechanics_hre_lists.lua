...
mkHRE.factions_states = {
	["loyal"] = {"Віддані", "Ця фракція вірна імператору і завжди буде його підтримувати."},
	["ambitious"] = {"Амбітні", "Ця фракція вкрай честолюбна і переслідує свої власні цілі на шкоду іншим."},
	["malcontent"] = {"Бунтівні", "Імператор сильно образив цю фракцію, і вона завжди виступатиме проти нього."},
	["discontent"] = {"Незадоволені", "Ця фракція незадоволена діями імператора і виступатиме проти нього, якщо це не суперечитиме її інтересам."},
	["neutral"] = {"Байдужі", "Цій фракції байдужі дії імператора, і вона діятиме здебільшого в інтересах імперії."},
	["emperor"] = {"Імператорська фракція", "Лідер цієї фракції є нинішнім імператором Священної Римської імперії."},
	["pretender"] = {"Претенденти", "Ця фракція претендує на трон Священної Римської імперії."},
	["puppet"] = {"Маріонетки", "Ця фракція існує лише формально, повністю підкоряючись забаганкам імператора."}
};
