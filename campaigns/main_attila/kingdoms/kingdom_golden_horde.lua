...
function Add_Kingdom_Golden_Horde_Listeners()
	...
	if cm:is_multiplayer() == false then
		Register_Decision(
			...
			function() 	
				local conditionstring = "Умови:\n\n([[rgba:8:201:27:150]]Y[[/rgba]]) - Гра за Улус Джучі.\n([[rgba:8:201:27:150]]Y[[/rgba:8:201:27:150]]) - Немає фракції Золота Орда.\n";
				...
				for i = 1, #REGIONS_GOLDEN_HORDE do
					...
					if region:owning_faction():name() == cm:get_local_faction() then
						conditionstring = conditionstring.."([[rgba:8:201:27:150]]Y[[/rgba]]) - Володіння регіоном "..REGIONS_NAMES_LOCALISATION[REGIONS_GOLDEN_HORDE[i]]..".\n";
					else
						conditionstring = conditionstring.."([[rgba:255:0:0:150]]X[[/rgba]]) - Володіння регіоном "..REGIONS_NAMES_LOCALISATION[REGIONS_GOLDEN_HORDE[i]]..".\n";
					end
				end
			
				conditionstring = conditionstring.."\nРезультат:\n\n- Перетворення на фракцію [[rgba:255:215:0:215]]Золота Орда[[/rgba]].";
